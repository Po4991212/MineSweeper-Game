...
public class MineSweeperFrame extends JFrame {
    ...
    protected void frameInit(){
        ...
        cellButtons = new MineSweeperCell[10][10];
        for (int i = 0; i < 10; i++){
            for (int j = 0; j <10; j++){
                ...
                cell.setFont(new Font("Arial", Font.PLAIN, 45));
            }
        }
    }
    ...
    public void gameOver(){
        ...
        JOptionPane.showMessageDialog(cell, "You Clicked On A Mine!!!");
    }
